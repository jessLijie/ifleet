...
public class LogbookController {
    ...
    @RequestMapping("/")
    public ModelAndView logbookView(HttpServletRequest request) {
    ...
    public ModelAndView insertNew(@RequestParam String driverName,
    @RequestParam String type,
    @RequestParam String date,
    @RequestParam Double petrol) {
        java.sql.Date sqlDate = java.sql.Date.valueOf(date);
    ...
    public ModelAndView delete(@PathVariable Long logbookID) {
        // Use a parameterized query to filter records based on logbookID
